...
export declare type HeapRecordSelectOptions<HSP extends HsProperties> = {
  where?: HeapRecordFilter<HSP> | null | undefined
  limit?: number | null | undefined
  offset?: number | null | undefined
  order?: HeapOrderByV2<HSP> | null | undefined
}
export declare type HeapRecordFilter<HSP extends HsProperties> = FilterObject<HsFilterbleObjectStatic<HSP>>
export declare type HeapOrderByV2<HSP extends HsProperties> = OrderByDefinition<HsFilterbleObjectStatic<HSP>>
/**
 * Common interface for the serialized heap table record (HeapObject) of any table
 */
export declare type HeapObjectJson = Pick<HeapObjectBaseV2, 'id' | 'heapType'> & {
  createdAt: string
  updatedAt: string
  createdBy: HeapId | null
  updatedBy: HeapId | null
}
export { Money, Currency, MoneyJson } from 'core/heap/v2/Money'
