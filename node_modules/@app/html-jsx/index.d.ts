...
declare type LegacyExportInfo = [/*__filedomain*/ string, string, string] | ExportInfo
...
export declare type InitializerCtx = RichUgcCtx | ClientCtx
declare type InitializerPropArgument<P, E extends Element> = Omit<P, 'element' | 'ctx'> & {
  element: E
  ctx: ClientCtx
}
declare type Initializer<P, E extends Element> = (props: InitializerPropArgument<P, E>) => void
declare type InitializerComponent<P, E extends Element> = {
  (props: InitializerComponentProps<P>): jsx.JSX.Element
  initializer: Initializer<P, E>
}
declare type InitializerComponentProps<P> = P & {
  ref: string
  ctx: InitializerCtx
}
...
export declare function createClientInitializer<P, E extends Element = Element>(
  initializer: Initializer<P, E>,
  exportInfo?: LegacyExportInfo,
): InitializerComponent<P, E>
...
declare type AttributeValue =
  ...
  | ((...args: any[]) => any)
/**
 * Helper html node class
 *
 * Helps to register js/css and merge them
 */
...
export declare class PortalValue {
...
export declare class PortalRenderTarget {
  readonly portalId: string
  constructor(portalId: string)
}
export declare type HtmlNodeChild =
  | string
  | number
  | HtmlNode
  | PortalRenderTarget
...
export declare function toHtmlElement(document: Document, child: HtmlNodeChild): Node
export declare function appendChild<R extends Node = Element>(
  target: Element,
  child: HtmlNodeChild | Promise<HtmlNodeChild>,
): Promise<R>
export declare function insertBefore(
  target: Element,
  newElement: HtmlNodeChild | Promise<HtmlNodeChild>,
  beforeElement: Element,
): Promise<Node>
export declare function replaceWith(oldChild: Element, newChild: HtmlNodeChild | Promise<HtmlNodeChild>): Promise<Node>
...
export declare function isJSModule(a: any): a is JSModule
...
export declare function isCSSModule(a: any): a is CSSModule
export interface PortalTargetProps {
  name: string
}
export declare function PortalTarget(props: PortalTargetProps): PortalRenderTarget
export interface PortalProps {
  to: string
  dedupe?: boolean
}
export declare function Portal(props: PortalProps, ...children: Array<jsx.JSX.Child>): Promise<PortalValue>
export declare const builtinClientUrlPathPrefix = 's/static/builtin'
export declare function renderToStringJsx(child: HtmlNodeChild): string
