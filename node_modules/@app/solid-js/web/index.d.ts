...
declare function createRenderEffect<Next, Init = Next>(
...
declare function createMemo<Next extends Prev, Prev = Next>(
  fn: EffectFunction<undefined | NoInfer<Prev>, Next>,
): Accessor<Next>
declare function createMemo<Next extends Prev, Init = Next, Prev = Next>(
...
export function spread<T>(node: Element, accessor: (() => T) | T, isSVG?: Boolean, skipChildren?: Boolean): void
...
export declare const use: () => undefined
export declare const style: undefined
export declare const template: () => undefined
export declare const className: () => undefined
export declare const setAttribute: () => undefined
export declare const delegateEvents: () => undefined
export declare const styleInject: () => undefined

export { createMemo as memo, createRenderEffect as effect }
