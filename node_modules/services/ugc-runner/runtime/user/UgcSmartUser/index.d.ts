...
/**
 * SmartUser implementation for UGC runtime
 */
export declare class UgcSmartUser extends SmartUser<RichUgcCtx> {
  protected userApi: SmartUserApi<RichUgcCtx>
  protected fileServiceDirectHost: string
  protected fileServiceCdnHost: string
}
/**
 * Creates UgcUser by the given core user, collecting all additional info.
 */
export declare function constructUgcUser(ctx: RichUgcCtx, coreUser: UgcCtxUser2): Promise<UgcSmartUser>
export declare function updateAccountRole(ctx: RichUgcCtx, userId: HeapId, newRole: AccountRole): Promise<AccountRole>
export declare function updateUsername(ctx: RichUgcCtx, userId: HeapId, username: string): Promise<string>
/**
 * Mimics SmartUser for the User v1
 * Also exposes fields from UgcCtxUser1 for backward compatibility
 */
export declare class UgcSmartUserCompat extends UgcSmartUser {
  private user1
  constructor(ctx: LocationCtx, auth1: UgcCtxBaseAuth, user1: UgcCtxUser1)
  serialize(): UgcCtxUser1
  get roles(): UserRole[]
  get avatar(): Icon | undefined | null
  get purchasedProducts(): PurchasedProducts
  get phone(): string | null
  get email(): string | null
  updateAccountRole(_ctx: RichUgcCtx, newRole: AccountRole): Promise<void>
  updateUsername(_ctx: RichUgcCtx, username: string): Promise<void>
  updatePassword(_ctx: RichUgcCtx, _password: string): Promise<void>
  updateExtendedInfo(_ctx: RichUgcCtx, _info: UpdateExtendedUserInfoRaw): Promise<void>
}
